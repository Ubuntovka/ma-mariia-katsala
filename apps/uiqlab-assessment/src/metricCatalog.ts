...
export const METRIC_DEFINITIONS: readonly MetricDefinition[] = [
	...
	{ id: 'm9', name: 'Edge density', description: 'Measures the percentage of grayscale screenshot pixels detected as edges by the Canny detector. A higher percentage indicates more visual complexity; an edge image is also produced.' },
	{ id: 'm10', name: 'Feature congestion', description: 'Measures visual complexity by modeling the saliency of visual features in CIELAB space. It produces a numeric congestion value and a visual congestion map.' },
	{ id: 'm11', name: 'Subband entropy', description: 'Measures visual complexity through the efficiency of perceptual image encoding in CIELAB space. Higher entropy indicates greater visual complexity.' },
